...
--
-- Host: localhost
-- Generation Time: 2017-04-15 11:08:25
...
--
ALTER TABLE `balance_log`
  MODIFY `balance_log_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `auction`
  ...
  ADD CONSTRAINT `auction_username` FOREIGN KEY (`user_name`) REFERENCES `user` (`user_name`) ON DELETE NO ACTION ON UPDATE NO ACTION;
