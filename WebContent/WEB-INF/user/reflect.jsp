                ...
                <div class="account-amount clearfix mb-20">
                    <div class="amount amount1 ">
                        ...
                        <p>
                            ...
                            <span class="charge ft-orange ft-30 charge"></span>
                        </p>
                    </div>

                    <div class="amount amount3">
                        <p>锁定金额</p>
                        <p>￥<span class="ft-30 frozen"></span></p>
                    </div>
                </div>
                <div class="well form-inline" id="transfer-container">
                    <div class="">
                        <label>提现金额：</label>
                        <input type="text" class="input-sm transfer-form" id="input-money" name="money" value=""
                               placeholder="请输入提现金额.">
                    </div>
                    ...
                    <div class="text-left mt-10">
                        <button type="button" class="btn btn-orange btn-transfer-account mt-10"
                                id="btn0" style="margin-left: 70px;" data-loading-text="保存中...">提交审核
                        </button>
                    </div>
                </div>
            </div>
